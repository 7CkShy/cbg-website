...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'team.website': '个人主页',
    'team.honors': '人才称号',
    'team.projects': '主持科研项目',
    'team.teaching': '讲授课程',
    'team.admissions': '招生专业及方向',
    'team.selectedPublications': '代表性成果',
    'team.showAllPublications': '展开全部成果',
    'team.showLessPublications': '收起成果列表',
    // Lab Life
  ...
  en: {
    ...
    'team.honors': 'Honors',
    'team.projects': 'Research Projects',
    'team.teaching': 'Teaching',
    'team.admissions': 'Graduate Admissions',
    'team.selectedPublications': 'Selected Publications',
    'team.showAllPublications': 'Show all publications',
    'team.showLessPublications': 'Show fewer publications',
    // Lab Life
    'life.subtitle': 'Lab Life',
    'life.title': 'Lab Life',
